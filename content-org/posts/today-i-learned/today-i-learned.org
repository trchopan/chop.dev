...
I got the comment section to work on [[https://blog.chop.dev][blog.chop.dev]]. I setup [[https://disqus.com][Disqus]] but find out there much better option: [[https://utteranc.es/][Utterances]]. It based on Github issues and much suited for my site because it more developer oriented.
...
Today is a good day. With a lot of things todo, I still managed to buy the new domain and spin up the website at https://blog.chop.dev . It will be my site to dump all these writing to.
